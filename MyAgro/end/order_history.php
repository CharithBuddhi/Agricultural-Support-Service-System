            ...
            <div class="w-full mt-8">
                ...
                <div class="flex flex-wrap mr-16">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM transaction WHERE customer_id = '$user_id' AND customer_type = '$user_type1' ORDER BY FIELD(payment_status, 'Pending', 'Rejected', 'Process', 'succeeded', 'Completed', 'Canceled'), Reference_id DESC";
                        $result = $conn->query($sql);
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            Modal_Btn.forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    }else if(payment_status == "succeeded") {

                        document.getElementById('payment_status_view').innerText = "Prepared";
                        document.getElementById('payment_status_view').style.color = "#a3e635";

                    }else if(payment_status == "Process") {

                        document.getElementById('payment_status_view').innerText = "Process";
                        document.getElementById('payment_status_view').style.color = "#fb923c";

                    }else if(payment_status == "Rejected") {

                        document.getElementById('payment_status_view').innerText = "Rejected";
                        document.getElementById('payment_status_view').style.color = "#ea580c";
