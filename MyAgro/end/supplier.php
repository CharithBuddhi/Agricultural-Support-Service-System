...
<body class="bg-cover h-fit bg-no-repeat bg-[url('images/reg.jpg')]">
    
    <!-- navigation bar -->
    <?php require('header.php'); ?>

    <!-- registration form -->
    <div class="flex flex-col items-center mr-[250px] h-[930px]">
        <div class="flex flex-col items-center mt-3">
            <h2 class="mb-3 text-3xl font-semibold text-white">Register for your MyAgro account</h2>
        </div>
        <form enctype="multipart/form-data" action="connect.php" method="POST" class="flex flex-col items-center text-md border rounded-3xl w-[350px] bg-[#D9D9D9]/80">

            <div class="flex flex-col w-[330px]" id="commonfield">
                
                <label for="username" class="mt-[140px]">Enter your Username</label>
                <input type="text" placeholder=" E.g. charitha" minlength="5" id="username" name="username" class="rounded-md h-8 px-1 font-semibold placeholder:italic placeholder:text-[14px]" required>
                
                <label for="password" class="mt-2">Enter your Password</label>
                <div class="relative flex items-center">
                    <input type="password" placeholder=" pick up your password" id="password" name="password" class=" rounded-md font-semibold h-8 px-1 placeholder:italic placeholder:text-[14px] w-full" required>
                ...
                <select name="usertype" id="usertype" class="rounded-lg font-semibold h-8  px-1 text-[14px]" >
                    <option value="supplier" class="font-semibold text-[14px]">Supplier</option>
                </select>

                <label for="supplierNIC"  class="mt-2">Enter your NIC number</label>
                <input type="text" name="nic" pattern="\d+" maxlength="12" minlength="9" id="supplierNIC" placeholder=" E.g. 458458756789 or 258963147(without v,x)" class="rounded-md font-semibold h-8 px-1 placeholder:text-[14px] placeholder:italic" required>
                
                <label for="shop_name" class="mt-2">Enter your shop name</label>
                <input type="text" name="shop_name" id="shop_name" placeholder=" E.g. Agro Mart" class="rounded-md h-8 font-semibold placeholder:text-[14px] px-1 placeholder:italic" required>
                
                <label for="supplierAddress" class="mt-2">Enter your address</label>
                <input type="text" name="address" id="supplierAddress" placeholder=" E.g. No 250/3, Colombo Road, Kandy" class="rounded-md h-8 font-semibold placeholder:text-[14px] px-1 placeholder:italic" required>
     
                <div class="mt-3">
                    <label for="supplierOTP" class="mt-2">Enter your OTP number</label>
                    <input name="verify_otp" type="text" id="verify_otp" pattern="[0-9]{4}" placeholder=" E.g. 0123" class="rounded-md w-[225px] font-semibold h-8 px-1 placeholder:text-[14px] placeholder:italic" required>
                ...
                <label for="supplierPhone" class="mt-3">Enter your phone number</label>
                <input type="tel" name="phone" id="supplierPhone" pattern="[0-9]{10}" placeholder=" E.g. 0795555555" class="rounded-md font-semibold h-8 px-1 placeholder:text-[14px] placeholder:italic" required>
                
                <label for="supplierProof" class="mt-3">Enter your shop registration image.</label>
                <input type="file" name="image" accept="image/*" id="supplierProof" class="rounded-md h-[70px] border-4 placeholder:text-[14px] px-1 placeholder:italic" required>
                
                <div class="flex">
                    <button type="reset" class="mt-5 mr-6 h-8 rounded-full font-semibold w-[145px] bg-[#6EE70F]/80 hover:text-[#000000] text-[#ffffff]">Clear</button>
                    <button type="submit" name="register" id="request_btn" class="mt-5 h-8 rounded-full w-[160px] bg-[#6EE70F]/80 font-semibold disabled:bg-[#6EE70F]/40 hover:text-[#000000] text-[#ffffff]">Request</button>
                </div>
        ...
        <form action="sendmail.php" method="POST" class="relative flex flex-col bottom-[855px]">
