            ...
            if(mysqli_num_rows($query_run) > 0){
                ...
                ?>
                    ...
                    <div class="flex justify-between pt-2 bg-white">
                        <div class="text-lg ">
                            <label for="video" class="pl-1 text-lg font-semibold "><?php echo ucfirst($vievName); ?></label>    
                        </div>
                        <form action="" method="POST">
                            <div class="flex pr-5 text-lg gap-7">
                                <button type="submit" class="flex gap-1" name="like" value="<?php echo $id; ?>">
