        ...
        <div class="relative flex flex-wrap w-4/5 gap-12 mt-10">
            ...
            <?php
                ...
                if(isset($_POST['filter'])){
                    ...
                    $query = "SELECT agro_id, agro_image, agro_name,total_quantity, meassure, agro_price, agro_quantity, agro_location, shop_name, s.supplier_status FROM agrochemical JOIN supplier s ON agrochemical.supplier_id = s.supplier_id "; 
                    ...
                    $query = "SELECT agro_id, agro_image,total_quantity,meassure, agro_name, agro_price, agro_quantity, agro_location, shop_name, s.supplier_status FROM agrochemical JOIN supplier s ON agrochemical.supplier_id = s.supplier_id WHERE agro_category = '$category' AND fertilizer_category = '$type' AND total_quantity > 0 AND s.supplier_status = 0 ";
                    $result = mysqli_query($conn, $query);
