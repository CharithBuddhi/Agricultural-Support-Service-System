                                                ...
                                                foreach($query_run as $items){
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="flex justify-center gap-4">
                                                            <a href="conterol_price.php?id=<?php echo $items['price_id'] ?>&name=<?php echo $items['crop_name'] ?>&varieties=<?php echo $items['varieties_name'] ?>&search=<?php echo $filtervalues ?>&crop=<?php echo $items['crop_category'] ?>">
