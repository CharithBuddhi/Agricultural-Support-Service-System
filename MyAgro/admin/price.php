...
<div class="flex">
    ...
    <div class="flex flex-col w-[79%]">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-mt-2">
                        ...
                        <div class="card-body" id="price_table">
        ...
        <div class="flex ml-5">
            ...
            <form action="harvest.php" method="post" class="flex flex-col gap-4 text-lg">
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-col">
                        <label for="">varieties name</label>
                        <input type="text" class="rounded-md">    
                    </div>                   
                </div>
                <div class="flex gap-4">
                    <div class="flex flex-col">
                        <label for="">Strat Month</label>
                        <select name="start_month" id="start_month" class="text-black rounded-md w-[200px]">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="end_month" id="end_month" class="text-black rounded-md w-[200px]">
                            <option value="" disabled  selected>Select Month</option>
                            <option value="January">January</option>
                            <option value="February">February</option>
                            <option value="March">March</option>
                    ...
                    <button type="submit" name="harvest" id="harvest" class="w-32 mt-3 bg-blue-500 border-2 border-white hover:bg-blue-600 hover:text-white rounded-xl h-9">Submit</button>                
                </div>
            </form>
